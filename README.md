...
- [Making Pretty PDFs with Quarto](https://nrennie.rbind.io/blog/pdf-quarto/making-pdf-with-quarto-typst-latex/) - A blog post showing how to customise the styling of PDF documents, and save the styling into a Quarto extension to make it easier to reuse and share.
