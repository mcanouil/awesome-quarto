...
- [Nick Giangreco's mccv website](https://github.com/ngiangre/mccv) - Nick Giangreco's website of the Monte Carlo Cross Validation (mccv) package with a python package to install the mccv algorithm, multiple vignettes, and references to articles utilizing the algorithm for clinical machine learning. 
