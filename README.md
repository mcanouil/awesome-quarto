...
- [Parameterized Quarto reports improve understanding of soil health](https://jadeynryan.github.io/2023_posit-parameterized-quarto/) - posit::conf(2023) talk by Jadey Ryan provides an example workflow of creating parameterized reports with HTML and MS Word outputs (recording coming soon on Posit YouTube).
