...
- [Introducing Quarto's Native Julia Engine](https://www.youtube.com/watch?v=kk5Pll_dItQ) - JuliaCon 2025 talk on the native Julia engine shipped in Quarto 1.5, covering RCall support and the expandable-cell mechanism, by Julius Krumbiegel.
...
- [Applied Machine Learning for Tabular Data](https://github.com/aml4td/website) - An open textbook on tabular machine learning by Max Kuhn and Kjell Johnson, keeping the core text decoupled from separate R and Python computing supplements (see <https://aml4td.org/>).
